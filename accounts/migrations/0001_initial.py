    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medical_id_proof', models.FileField(blank=True, null=True, upload_to='id_proofs/')),
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'code', 'expires_at'], name='accounts_lo_user_id_64e7bb_idx'), models.Index(fields=['expires_at'], name='accounts_lo_expires_4ba799_idx')],
            },
        ),
    ]
